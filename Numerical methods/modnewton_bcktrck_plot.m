function [xk, fk, gradfk_norm, k, xseq, btseq, err_fseq, ordconv_seq, ...
    totalTimeCost, timeCostseq] = modnewton_bcktrck_plot(x0, x_sol, f, ... 
    gradf, Hessf, kmax, tolgrad, c1, rho, btmax, FDgrad, FDHess, h)

%
% [xk, fk, gradfk_norm, k, err_fseq, ordconv_seq, ...
% totalTimeCost, timeCostseq] = modnewton_bcktrck_plot(x0, x_sol, f, ...
% gradf, Hessf, kmax, tolgrad, c1, rho, btmax, FDgrad, FDHess, h)
%
